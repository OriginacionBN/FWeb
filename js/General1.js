...
function Modificar(){
	var total = etiquetas.length;
	for(var i = 0; i<total; i++){
		document.getElementById(etiquetas[i]).disabled = false;
	}
	document.getElementById('idFila').value = -1;
	document.getElementById('analista').disabled = false;
	document.getElementById('analista').value = <?=Session.getActiveUser().getEmail()?>;
	document.getElementById('analista').innerHTML = <?=Session.getActiveUser().getEmail()?>;
	document.getElementById('analista').disabled = true;
	document.getElementById('ruc').disabled = true;
	document.getElementById('oficinas').disabled = true;
